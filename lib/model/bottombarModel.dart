...
import 'package:plant_sid_app/app_views/my_account.dart';
    ...
    return Scaffold(
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        items: [
          ...
          BottomNavigationBarItem(icon: Icon(FontAwesomeIcons.cartShopping),label: "Favourites"),
          BottomNavigationBarItem(icon: Icon(FontAwesomeIcons.cartShopping),label: "My Account"),
